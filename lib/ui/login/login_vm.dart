...
import 'package:th_app/helpers/connection_helper.dart';
import 'package:th_app/helpers/sp_helper.dart';
      ...
      try {
        ...
        switch (res.statusCode) {
          case 200:
            ...
            if(res_d.status){
              mSP.saveTokenAndAccountId(res_d?.loginData?.token, res_d?.loginData?.account_id);
            }
            return res_d;
          default:
            // HTTP Error
