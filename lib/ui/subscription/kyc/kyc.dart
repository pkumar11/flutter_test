...
//         );
  ...
  Widget _buildList(BuildContext c, KycRes res) {
    ...
    aadharCard = TextEditingController(
        text: res.status ? res.data.aadharCardNumber : '');
    passport =
        TextEditingController(text: res.status ? res.data.passportNumber : '');
    gstin = TextEditingController(text: res.status ? res.data.gstinNumber : '');
    iec = TextEditingController(text: res.status ? res.data.iecNumber : '');
    voter =
        TextEditingController(text: res.status ? res.data.voterIdNumber : '');
    pancard =
        TextEditingController(text: res.status ? res.data.pancardNumber : '');
    bussinessregistration = TextEditingController(
        text: res.status ? res.data.bussinessRegistration : '');
            ...
            child: ListView(
              children: <Widget>[
                Container(
                  ...
                  margin:
                      EdgeInsets.symmetric(vertical: GAP_LARGE, horizontal: 10),
                  child: Column(
                    children: <Widget>[
                      Text('Aadhar card',
                          style: TextStyle(
                      ...
                      TextField(
                          ...
                          readOnly:
                              res.data.aadharCardNumber.isEmpty ? false : true,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextField(
                          ...
                          readOnly:
                              res.data.passportNumber.isEmpty ? false : true,
                          decoration: InputDecoration(
                            fillColor: Colors.white,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextField(
                          ...
                          enableInteractiveSelection: false,
                          keyboardType: TextInputType.number,
                          readOnly: res.data.bussinessRegistration.isEmpty
                              ? false
                              : true,
                          decoration: InputDecoration(
                            fillColor: Colors.white,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextField(
                          ...
                          keyboardType: TextInputType.number,
                          readOnly:
                              res.data.voterIdNumber.isEmpty ? false : true,
                          decoration: InputDecoration(
                            fillColor: Colors.white,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextField(
                          ...
                          keyboardType: TextInputType.number,
                          readOnly:
                              res.data.pancardNumber.isEmpty ? false : true,
                          decoration: InputDecoration(
                            fillColor: Colors.white,
